...
class FlatObsWrapperRGB(gym.core.ObservationWrapper):
    """
    Encode mission strings using a one-hot scheme,
    and combine these with observed images into one flat array
    """
...
class FlatObsWrapperCharEmbed(gym.core.ObservationWrapper):
    """
    ...
    def __init__(self, env, maxStrLen=64, includeText=True):
        ...
        if self.includeText:
            imgSize = imgSize + self.numCharCodes * self.maxStrLen + self.env.embed_dim[0]*2 + self.env.norm_dim*2
